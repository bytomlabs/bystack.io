...
import BirdRuleCont from '../components/BirdRuleCont';
...
const Rules = () => (
  <Layout>
    ...
    />
    <PageTitle title={<Msg id="home_title" />} subTitle={<Msg id="rules_sub_title" />} />
    <Cont>
      ...
      {/* <Line /> */}
      {/* <Button href={url}><Msg id="home_btn_vote" /></Button> */}
    </Cont>
  </Layout>
);
