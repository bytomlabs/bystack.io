    ...
    <Wrap lang={language}>
      <Countdown>
        ...
        <Info>
          ...
          <Link to="/detail"><img src={img_arrow} /><Msg id="home_btn_plan" /></Link>
          <Link to="/rules"><img src={img_arrow} /><Msg id="home_btn_sub_rule" /></Link>
          <Link to={'/vote_reward'}><img src={img_arrow} /><span>早鸟投票收益查询</span></Link>
        </Info>
      </Countdown>
