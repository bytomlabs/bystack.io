...
export default class NodeList extends Component {
  ...
  render() {
    ...
    const officialColumns = [
      ...
      {
        title: '',
        render: (text, item) => <LinkButton type="primary" ghost onClick={(e) => this.handleVote(e)}><Msg id="node_list_btn_vote" /></LinkButton>
      },
    ];
    // early bird
    const columns = [
      ...
      },
      {
        ...
        render: (text, item) => (
          <>
            <Link style={{color: '#fff'}} to={`/node/node_detail?id=${item.uuid}`}>
